...
import type { SummaryMetric } from "../../types/reconciliation.types";
...
export function StatCard({
  ...
  if (loading) {
    return <div className="overview-kpi-skeleton" aria-hidden />;
  }
  ...
  const trendClass =
    metric?.trend === "down"
      ? "finance-recon-stat-trend--down"
      : "finance-recon-stat-trend--up";
  ...
  return (
    ...
    >
      ...
      <h2 className="overview-kpi-card__value">{value}</h2>
      {metric && (
        <div className="overview-kpi-card__foot">
          <p className="overview-kpi-card__subtitle finance-recon-stat-trend">
